...
geordi2_summary$tasktype <- as.factor(ifelse(geordi2_summary$anontask > 0,1,0))
geordi2_summary$viewingtype <- as.factor(ifelse(geordi2_summary$anonviewing > 0,1,0))
geordi2_summary$socialzingtype <- as.factor(ifelse(geordi2_summary$anonsocialize > 0,1,0))
geordi2_summary$learntype <- as.factor(ifelse(geordi2_summary$anonlearn > 0,1,0))
geordi2_summary$communitytype <- as.factor(ifelse(geordi2_summary$anoncommunity > 0,1,0))
geordi2_summary$impressiontype <- as.factor(ifelse(geordi2_summary$anonimpressions > 0,1,0))
geordi2_summary$classifyingtype <- as.factor(ifelse(geordi2_summary$anonclassifications > 0,1,0))
...
t.test(geordi2_summary_first$total_classifications~geordi2_summary_first$anontype)
...
tapply(geordi2_summary_first$totalinteraction,geordi2_summary_first$anontype, FUN = median)
...
### TASK
# More Classifying
tapply(geordi2_summary_first$total_classifications,geordi2_summary_first$tasktype, FUN = mean)
t.test(geordi2_summary_first$total_classifications~geordi2_summary_first$tasktype)
# More Task
tapply(geordi2_summary_first$task,geordi2_summary_first$tasktype, FUN = mean)
t.test(geordi2_summary_first$task~geordi2_summary_first$tasktype)

### VIEWING
# More Classifying
tapply(geordi2_summary_first$total_classifications,geordi2_summary_first$viewingtype, FUN = median)
t.test(geordi2_summary_first$total_classifications~geordi2_summary_first$viewingtype)
# More Viewing
tapply(geordi2_summary_first$viewing,geordi2_summary_first$viewingtype, FUN = median)
t.test(geordi2_summary_first$viewing~geordi2_summary_first$viewingtype)

### Community
# More Classifying
tapply(geordi2_summary_first$total_classifications,geordi2_summary_first$communitytype, FUN = median)
t.test(geordi2_summary_first$total_classifications~geordi2_summary_first$communitytype)
# More Community
tapply(geordi2_summary_first$community,geordi2_summary_first$communitytype, FUN = median)
t.test(geordi2_summary_first$community~geordi2_summary_first$communitytype)

# When users do contribute anonymously what does this behaviour mean for their future participation
...
geordi2_summary_post <- geordi2_summary[which(geordi2_summary$Session > 1 & geordi2_summary$type == "1"),]
