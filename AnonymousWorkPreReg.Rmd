...
* __Pre-registration traces__:  

* __Time to register__: 
...
nextactivity$meta[nextactivity$new.category %in% c( "view-profile-author","gs-about","gs-collections","view-profile-author"
                                        ,"gs-favorites","keyword search","hashtag-sidebar","view-member-profile")] <- "community"
...
q5.meta <- ggbarplot(subset(afterlogin,meta != "classification"), 
                     x = "meta", y = "users",fill = "meta", color = "meta",xlab="Meta-Interaction",
                    palette = "jco", sort.val = "desc",rotate = TRUE, sort.by.groups = TRUE)
