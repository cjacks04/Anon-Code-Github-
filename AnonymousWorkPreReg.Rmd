...
# Time spent in pre-registration. 
# Diversity of pre-registration activities
...
# Are there differences in volunteers who contribute anonymously compared to those who dont?
...
```{r include=FALSE, warning=FALSE}
#remove(anon_prereg,prereg_summary)
```
