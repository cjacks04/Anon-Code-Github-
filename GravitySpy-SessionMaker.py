...
############## Import Raw datafile ##############
# Data location: /Users/coreyjackson/Dropbox/INSPIRE/Papers & Presentations/Anonymous Work (Journal)/Data/Session

raw_data = pd.read_csv('geordi-session.csv') # CHANGE NAME OF .CSV FILE
...
# Export dataframe
anon_population.to_csv('geordi-session-added.csv') #Change File name to project name. 
